...
public class CameraControl : MonoBehaviour {
	...
	void Update () {
		...
		transform.position = new Vector3((centerPoint.width * tileSize)-tileSize/2, (centerPoint.height * tileSize)-tileSize/2, transform.position.z);
		...
		theCamera.orthographicSize = (tileSize/2)*worldSize.height;
	}
}
